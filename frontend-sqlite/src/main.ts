...
import customTable from "@/modules/core/components/data-display/custom-table.vue";
...
app.component('custom-dropdown', defineAsyncComponent(() => import("@/modules/core/components/inputs/custom-dropdown.vue")));
