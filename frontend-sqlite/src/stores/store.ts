...
export const useMainStore = defineStore(
{
    ...
    actions: 
    {
        ...
        getValue(currencyID: string, amount: number) 
        {
            ...
            return amount * (this.currencies.lastSuccessfulData.find(x => x.id == currencyID)?.rateToBase as number ?? 0);
        },
        ...
        findContainerByPubID(id:string) 
        {
            ...
            return this.containers.lastSuccessfulData.find(x => x.id == id); 
        },
