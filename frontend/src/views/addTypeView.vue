    ...
    <div id="topDiv" class="center">
        ...
        <div id="containersSelectDiv" v-if="!isLoading">
            <grid-shortcut columns="100px 1fr" class="fullWidth field">
                <div class="middleLeft">Type Name:</div>
...
export default
{
    ...
    methods:
    {
        async upload()
        {
            ...
            this.store.authPost(`/api/finance/types/add`, body)
            .then(() => { alert("Successfully added type."); })
            .catch(error => { alert(`Error trying to upload type. ${error}`); })
