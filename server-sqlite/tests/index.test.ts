...
import authTests from './suites/auth/auth.test.js';
import containerTests from './suites/container/container.test.js';
import currencyTests from './suites/currency/currency.test.js';
import txnTypeTests from './suites/txnTag/txnTag.test.js';
import transactionTests from './suites/transaction/transaction.test.js';
import currencyRateSrcs from './suites/currencyRateSource/currencyRateSource.test.js';
import calculationsTest, { testForCalculationsInternals } from './suites/calculations/calculations.test.js';
